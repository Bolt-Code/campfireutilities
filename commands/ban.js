...
exports.run = async(client, message, args) =>{
  ...
  logchannel.send(`<:ban:769001735040925707> **${user.tag}** banned at \`${date}\` (${user.id})\nReason: ${reason}`)

  var kickmsg = new Discord.MessageEmbed()
  .setColor('#4BCC85') 
  .setDescription(`<a:success:769189756051390471> ${user} has been **banned** with ID \`${puncode}\``)
